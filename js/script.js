(function ($) {
    ...
    $(document).ready(function () {
            ...
            $('.sc-google-map').each(function(){
                ...
                var geocoder = new google.maps.Geocoder(),
                    mapOptions = {
                        ...
                        center: new google.maps.LatLng(40.3285123, -3.7614179),
                        zoom: zoom
                    },
        ...
        if ($('#wpgmappity-map-4').length){
            ...
            var latlng = new google.maps.LatLng(40.3285123, -3.7614179);
            var options = {
              center : latlng,
              scrollwheel :  false,
              mapTypeId: google.maps.MapTypeId.ROADMAP,
            ...
            var point0 = new google.maps.LatLng(40.3285123, -3.7614179);
